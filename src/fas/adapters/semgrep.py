...
class SemgrepAdapter:
    ...
    def parse(self,payload,context,*,raw_artifact_id=None,source_artifact_id=None):
        ...
        for index,item in enumerate(results):
            ...
            if path and raw_artifact_id: location=SourceLocation(artifact_id=source_artifact_id,path=str(path),line_start=start.get("line"),line_end=end.get("line") or start.get("line"),column_start=start.get("col"),column_end=end.get("col"))
